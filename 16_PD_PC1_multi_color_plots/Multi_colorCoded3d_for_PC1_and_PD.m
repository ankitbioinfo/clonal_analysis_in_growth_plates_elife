...
set(gca,'Color','k');
mkdir 'multicolorCoded3d_for_PC1_and_PD';
 % saveas(h,[savepath,'colorcoded',fname,'.png']);
  saveas(h,[savepath,'multicolorCoded3d_for_PC1_and_PD/sec_',num2str(section(sec)),'_colormap_between_PD_and_PC1_',fname,'.fig']);
  dlmwrite([savepath,'multicolorCoded3d_for_PC1_and_PD/',fname,'.dat'],data);
  close all 
end
