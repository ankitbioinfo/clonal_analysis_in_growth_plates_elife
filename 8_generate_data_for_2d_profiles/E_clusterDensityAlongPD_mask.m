...
[AvgMeanFeatures,AvgStdFeatures,Xbin,Ybin,dataAvgMeanFeatures]=save_data_for_create_profile(LCC_col,Features,RZ,HZ,radius_col,8);
save([outputpath,'SaveVariablesForPlotCol_.mat'],   'AvgMeanFeatures','AvgStdFeatures','Xbin','Ybin','dataAvgMeanFeatures');
nanmean(AvgMeanFeatures{33})

[AvgMeanFeatures,AvgStdFeatures,Xbin,Ybin,dataAvgMeanFeatures]=save_data_for_create_profile(LCC_clu,Features,RZ,HZ,radius_clu,8);
