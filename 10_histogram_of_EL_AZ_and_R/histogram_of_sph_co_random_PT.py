...
def main():
	...
	datapath2='plothist_embryo_random/PT/'


	fig,ax=plt.subplots(2,2,figsize=(8,5))
	
	plot_everything(datapath1,ax,'r','E18.5 PT real',0.3,5)
	plot_everything(datapath2,ax,'b','E18.5 PT random',0.6,1)
	...
	fig.savefig('histogram_elevation_Random_PT.png',bbox_inches='tight',dpi=300)
	fig.clf()
