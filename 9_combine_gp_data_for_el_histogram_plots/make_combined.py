...
def merge_sph(fname,save):
	fw=open('plothist_embryo/'+save+'/spherical_coordinate.txt','w')
	fw1=open('plothist_embryo/'+save+'/spherical_coordinate_not_in_connected_component.txt','w')
...
def merge_deg(fname,save):
	fw=open('plothist_embryo/'+save+'/degree_of_clusters.txt','w')
	for i in range(len(fname)):
