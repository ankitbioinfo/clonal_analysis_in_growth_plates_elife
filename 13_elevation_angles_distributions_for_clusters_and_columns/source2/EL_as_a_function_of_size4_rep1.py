...
def main():
	...
	fig.tight_layout()
	fig.savefig('EL_against_colclu_real_random_rep1.png',bbox_inches='tight',dpi=300)
	#fig.savefig('histogram_elevation_cluster_DF.png',bbox_inches='tight',dpi=300)
	fig.savefig('EL_against_colclu_real_random_rep1.svg',format='svg',bbox_inches='tight',dpi=1200)
	fig.clf()
