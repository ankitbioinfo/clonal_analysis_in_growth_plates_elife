...
def plot_everything(datapath,PD_PC1_file,ax,mycolor,legendlabel,cutoff):
	...
	#print(el_fraction1.shape,el_fraction2.shape)	
	#print(clusize1)
...
def main():
	...
	datapath2='plothist_embryo_random/DF/rep2/'
	datapath3='plothist_embryo/PT/'
	datapath4='plothist_embryo_random/PT/rep2/'
	...
	fig.tight_layout()
	fig.savefig('EL_against_colclu_real_random_rep2.png',bbox_inches='tight',dpi=300)
	#fig.savefig('histogram_elevation_cluster_DF.png',bbox_inches='tight',dpi=300)
	fig.savefig('EL_against_colclu_real_random_rep2.svg',format='svg',bbox_inches='tight',dpi=1200)
	fig.clf()
