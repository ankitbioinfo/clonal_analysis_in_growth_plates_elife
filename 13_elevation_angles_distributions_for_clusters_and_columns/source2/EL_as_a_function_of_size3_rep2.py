...
def main():
	...
	fig.tight_layout()
	fig.savefig('EL_against_size_real_random_Rep2.png',bbox_inches='tight',dpi=300)
	#fig.savefig('histogram_elevation_cluster_DF.png',bbox_inches='tight',dpi=300)
	

	fig.savefig('EL_against_size_real_random_Rep2.svg',format='svg',bbox_inches='tight',dpi=1200)
