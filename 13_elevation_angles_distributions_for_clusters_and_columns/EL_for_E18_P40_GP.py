...
def plot_everything(datapath,PD_PC1_file):
	...
	return YY,el_fraction1
	
	
def GPplot(YY,YY2,el_fraction1,el_fraction2,ax,legendlabel):
...
def main():
	...
	a1,el_fraction1=plot_everything(datapath1,d1)
	a2,el_fraction2=plot_everything(datapath3,d3)
	
	GPplot(a1,a2,el_fraction1,el_fraction2,ax[0], 'E18.5')
	
	
	a1,el_fraction1=plot_everything(datapath2,d2)
	a2,el_fraction2=plot_everything(datapath4,d4)
	
	GPplot(a1,a2,el_fraction1,el_fraction2,ax[1], 'P40')
	
	#ax[0,0].legend(prop={'size': 7},loc='upper right')
	ax[0].legend().set_visible(False)
	ax[1].legend(title="El angle",prop={'size': 6},loc='upper right',bbox_to_anchor=(1.39,1.03))
	...
	ax[0].set_ylim([0.5,1.09])
	ax[1].set_ylim([0.5,1.09])
	#ax[1,0].set_ylim([0.5,1.09])
	#ax[1,1].set_ylim([0.5,1.09])
	

	fig.tight_layout()
	fig.savefig('EL_for_E18_P40_GP.png',bbox_inches='tight',dpi=300)
	#fig.savefig('EL_for_E18_P40.svg',format='svg',bbox_inches='tight',dpi=1200)
	fig.clf()
