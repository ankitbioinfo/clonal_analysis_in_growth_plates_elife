...
dir2=strcat('profiles_against_sizes','/');
if ~exist([dir2],'dir')
    mkdir([dir2]);
end
...
path=allpathEmbryo{1};s=strsplit(path,'Nuclei_and_CellsE185_'); p11=strcat('MakeListNucleiLabelled/',s{2});r11=strcat('RandomSampling/',s{2});
path=allpathEmbryo{3};s=strsplit(path,'Nuclei_and_CellsE185_'); p12=strcat('MakeListNucleiLabelled/',s{2});r12=strcat('RandomSampling/',s{2});
path=allpathEmbryo{5};s=strsplit(path,'Nuclei_and_CellsE185_'); p13=strcat('MakeListNucleiLabelled/',s{2});r13=strcat('RandomSampling/',s{2});
...
path=allpathPostnatal{1};s=strsplit(path,'Nuclei_and_CellsP40_'); pn11=strcat('MakeListNucleiLabelled/',s{2});r11=strcat('RandomSampling/',s{2});
path=allpathPostnatal{3};s=strsplit(path,'Nuclei_and_CellsP40_'); pn12=strcat('MakeListNucleiLabelled/',s{2});r12=strcat('RandomSampling/',s{2});
path=allpathPostnatal{5};s=strsplit(path,'Nuclei_and_CellsP40_'); pn13=strcat('MakeListNucleiLabelled/',s{2});r13=strcat('RandomSampling/',s{2});
