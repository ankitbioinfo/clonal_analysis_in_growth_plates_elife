...
def main():
	datapath1='plothist_postnatal/DF/'
	...
	d1=['1_S151_m2_distalfemur.dat', '2_S152_m3_distalfemur.dat',  '3_S152_m4_distalfemur.dat']  
	d2=['1_S151_m2_proximaltibia.dat','2_S152_m3_proximaltibia.dat', '3_S152_m4_proximaltibia.dat' ]
	...
	a1=plot_everything(datapath1,d1,ax[0],'r','P40 DF',cutoff)
	a2=plot_everything(datapath2,d2,ax[1],'b','P40 PT',cutoff)
	...
	fig.tight_layout()
	fig.savefig('Freq_clone_P40.png',bbox_inches='tight',dpi=300)
	#fig.savefig('histogram_elevation_cluster_DF.png',bbox_inches='tight',dpi=300)
	fig.savefig('Freq_clones_P40.svg',format='svg',bbox_inches='tight',dpi=1200)
	fig.clf()
