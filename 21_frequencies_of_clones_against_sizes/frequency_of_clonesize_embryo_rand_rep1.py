...
def main():
	...
	datapath1='plothist_embryo_random/DF/rep1/'
	datapath2='plothist_embryo_random/PT/rep1/'
	...
	fig.tight_layout()
	fig.savefig('Freq_clones_random_rep1.png',bbox_inches='tight',dpi=300)
	#fig.savefig('histogram_elevation_cluster_DF.png',bbox_inches='tight',dpi=300)
	fig.savefig('Freq_clones_random_rep1.svg',format='svg',bbox_inches='tight',dpi=1200)
	fig.clf()
