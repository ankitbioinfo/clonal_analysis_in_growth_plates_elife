...
def main():
	...
	datapath1='plothist_embryo_random/DF/rep2/'
	datapath2='plothist_embryo_random/PT/rep2/'
	
	
	d1=['S153_m7_distalfemur.dat','S154_m3_distalfemur.dat','S154_m4_distalfemur.dat']
	d2=['S153_m7_proximaltibia.dat','S154_m3_proximaltibia.dat','S154_m4_proximaltibia.dat']
	'''
	...
	a1=plot_everything(datapath1,d1,ax[0],'r','E18.5 DF random',cutoff)
	a2=plot_everything(datapath2,d2,ax[1],'b','E18.5 PT random',cutoff)
	...
	fig.tight_layout()
	fig.savefig('Freq_clones_random_rep2.png',bbox_inches='tight',dpi=300)
	#fig.savefig('histogram_elevation_cluster_DF.png',bbox_inches='tight',dpi=300)
	fig.savefig('Freq_clones_random_rep2.svg',format='svg',bbox_inches='tight',dpi=1200)
	fig.clf()
